...
No theme provided or "--theme default" is the same
  ...
  $ slipshow file.md -o default_theme1.html
  $ slipshow --theme default file.md -o default_theme2.html
...
"--theme none" adds no theme
  ...
  $ slipshow --theme none file.md -o no_theme.html
...
"--theme <file.css>" replaces the default theme with the local file theme
  ...
  $ slipshow --theme my_theme.css file.md -o local_theme.html
...
Remote themes also replace the default theme but are included with a link:
  ...
  $ slipshow --theme https://example.org file.md -o remote_theme.html
...
Independently, an arbitrary number of css files can be included with "--css", without changing the theme:
  ...
  $ slipshow --css https://example.org file.md --css my_theme.css -o additional_css.html
