...
val go_next : Universe.Window.t -> Fast.mode -> unit Fut.t Fut.t
...
val go_prev : Universe.Window.t -> Fast.mode -> unit Fut.t Fut.t
val go_to : mode:Fast.mode -> int -> Universe.Window.t -> unit Fut.t Fut.t
