...
A *drawn* presentation replays the author's hand-drawn content. It makes presentations such as the ones made by `minutephysics <https://www.youtube.com/user/minutephysics>`_, `RSA animate <https://www.youtube.com/playlist?list=PL39BF9545D740ECFF>`_, or `Suckerpinch <https://www.youtube.com/watch?v=QVn2PZGZxaI>`_ possible for a live presentation. There is no need for drawing skills to make such a presentation more didactic, more entertaining, more satisfying to create, or just to feel more human than boring bullet points.
