...
Sometimes, mixing the approach helps improve the experience of deeply nested blocks. If it does not, consider :doc:`splitting in files <managing-large-presentations>`.
